...
export const ca: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: 'Proveïdor de transcripció',
        sttProviderDescription: 'Tria quin servei transcriu la teva veu. Deepgram Nova-3 pot gestionar millor el soroll que OpenAI Whisper.',
        sttOpenAISubtitle: 'Utilitza la teva clau API d\'OpenAI',
        sttDeepgramSubtitle: 'Requereix una clau API de Deepgram',
        deepgramApiKeyTitle: 'Clau API de Deepgram',
        deepgramApiKeyDescription: 'Necessària quan s\'utilitza Deepgram per a la transcripció. Obtén la teva clau a deepgram.com.',
