...
export const es: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: 'Proveedor de transcripción',
        sttProviderDescription: 'Elige qué servicio transcribe tu voz. Deepgram Nova-3 puede manejar mejor el ruido que OpenAI Whisper.',
        sttOpenAISubtitle: 'Usa tu clave API de OpenAI',
        sttDeepgramSubtitle: 'Requiere una clave API de Deepgram',
        deepgramApiKeyTitle: 'Clave API de Deepgram',
        deepgramApiKeyDescription: 'Necesaria cuando se usa Deepgram para la transcripción. Obtén tu clave en deepgram.com.',
