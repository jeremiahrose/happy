...
export const ja: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: '文字起こしプロバイダー',
        sttProviderDescription: '音声を文字起こしするサービスを選択します。Deepgram Nova-3はOpenAI Whisperよりもノイズに強い場合があります。',
        sttOpenAISubtitle: 'OpenAI APIキーを使用',
        sttDeepgramSubtitle: 'Deepgram APIキーが必要',
        deepgramApiKeyTitle: 'Deepgram APIキー',
        deepgramApiKeyDescription: 'Deepgramで文字起こしを使用する場合に必要です。deepgram.comでキーを取得してください。',
