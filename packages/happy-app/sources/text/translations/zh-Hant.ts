...
export const zhHant: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: '轉錄服務提供商',
        sttProviderDescription: '選擇用於語音轉錄的服務。Deepgram Nova-3 在處理噪音方面可能優於 OpenAI Whisper。',
        sttOpenAISubtitle: '使用您的 OpenAI API 金鑰',
        sttDeepgramSubtitle: '需要 Deepgram API 金鑰',
        deepgramApiKeyTitle: 'Deepgram API 金鑰',
        deepgramApiKeyDescription: '使用 Deepgram 進行轉錄時需要。在 deepgram.com 取得您的金鑰。',
