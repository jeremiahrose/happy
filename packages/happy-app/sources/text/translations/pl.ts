...
export const pl: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: 'Dostawca transkrypcji',
        sttProviderDescription: 'Wybierz usługę do transkrypcji mowy. Deepgram Nova-3 może lepiej radzić sobie z hałasem niż OpenAI Whisper.',
        sttOpenAISubtitle: 'Używa Twojego klucza API OpenAI',
        sttDeepgramSubtitle: 'Wymaga klucza API Deepgram',
        deepgramApiKeyTitle: 'Klucz API Deepgram',
        deepgramApiKeyDescription: 'Wymagany przy korzystaniu z Deepgram do transkrypcji. Uzyskaj klucz na deepgram.com.',
