...
export const it: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: 'Provider di trascrizione',
        sttProviderDescription: 'Scegli quale servizio trascrive la tua voce. Deepgram Nova-3 potrebbe gestire meglio il rumore rispetto a OpenAI Whisper.',
        sttOpenAISubtitle: 'Usa la tua chiave API OpenAI',
        sttDeepgramSubtitle: 'Richiede una chiave API Deepgram',
        deepgramApiKeyTitle: 'Chiave API Deepgram',
        deepgramApiKeyDescription: 'Necessaria quando si usa Deepgram per la trascrizione. Ottieni la tua chiave su deepgram.com.',
        deepgramApiKeyPlaceholder: 'dg-...',
