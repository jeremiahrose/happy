...
export const zhHans: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: '转录服务提供商',
        sttProviderDescription: '选择用于语音转录的服务。Deepgram Nova-3 在处理噪音方面可能优于 OpenAI Whisper。',
        sttOpenAISubtitle: '使用您的 OpenAI API 密钥',
        sttDeepgramSubtitle: '需要 Deepgram API 密钥',
        deepgramApiKeyTitle: 'Deepgram API 密钥',
        deepgramApiKeyDescription: '使用 Deepgram 进行转录时需要。在 deepgram.com 获取您的密钥。',
