...
export const pt: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: 'Provedor de transcrição',
        sttProviderDescription: 'Escolha qual serviço transcreve sua fala. Deepgram Nova-3 pode lidar melhor com ruído do que OpenAI Whisper.',
        sttOpenAISubtitle: 'Usa sua chave API do OpenAI',
        sttDeepgramSubtitle: 'Requer uma chave API do Deepgram',
        deepgramApiKeyTitle: 'Chave API do Deepgram',
        deepgramApiKeyDescription: 'Necessária ao usar Deepgram para transcrição. Obtenha sua chave em deepgram.com.',
