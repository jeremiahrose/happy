...
export const ru: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: 'Провайдер транскрипции',
        sttProviderDescription: 'Выберите сервис для распознавания речи. Deepgram Nova-3 может лучше справляться с шумом, чем OpenAI Whisper.',
        sttOpenAISubtitle: 'Использует ваш API-ключ OpenAI',
        sttDeepgramSubtitle: 'Требуется API-ключ Deepgram',
        deepgramApiKeyTitle: 'API-ключ Deepgram',
        deepgramApiKeyDescription: 'Необходим при использовании Deepgram для транскрипции. Получите ключ на deepgram.com.',
