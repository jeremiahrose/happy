...
export const en: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        sttProviderTitle: 'Transcription Provider',
        sttProviderDescription: 'Choose which service transcribes your speech. Deepgram Nova-3 may handle noise better than OpenAI Whisper.',
        sttOpenAISubtitle: 'Uses your OpenAI API key',
        sttDeepgramSubtitle: 'Requires a Deepgram API key',
        deepgramApiKeyTitle: 'Deepgram API Key',
        deepgramApiKeyDescription: 'Required when using Deepgram for transcription. Get your key at deepgram.com.',
